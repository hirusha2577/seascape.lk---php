                            ...
                            <div class="search-contents">
                                <form method="POST" action="./book-room.php">
                                    ...
                                    <div class="search-your-details">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <select class="selectpicker room_change search-fields form-control-2" name="room_type">
                                        ...
                                        <input type="hidden" name="room_price" id="room_price" value="LKR 6500.00">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <div class="form-group">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="tab1default">
                                            <div class="divv">
                                                ...
                                                <!-- paragraph -->
                                                <p>A room assigned for couple wish with the fresh sea air. Garden view from balcony and direct access to pool.</p>
                                            </div>
                                            <div>
                                                <table id="customers">
                                                    <tr>
