...
jQuery(document).ready(function () {
    ...
    jQuery("#txtCheckOut").blur(function () {
        validateEmpty("txtCheckOut", "spanCheckIn");
    });
...
function sendForm() {
    jQuery.ajax({
        ...
        data: {
            ...
            room_type: jQuery('#txtRoomType').val(),
            num_adults: jQuery('#txtAdults').val(),
            price: jQuery('#txtPrice').val(),
            num_child: jQuery('#txtChild').val(),
