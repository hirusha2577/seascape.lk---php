...
if (!User::authenticate()) {
    ...
    $active = 'event';
$EVENTIMAGE = new Event_Image($_GET['id']);
?>
<!DOCTYPE html>
                                ...
                                <div class="col s12 m12 l12">
                                    <div id="basic-form" class="card card card-default scrollspy">
                                        <div class="card-content">
                                            <h3 class="card-title cyan-text">Update Event Image</h3>
                                            <form method="post" id="room_inside_image_update_form">
                                                
                                                <div class="row section">
                                                    <div class="col s12 m12 l12">
                                                        <input type="hidden" name="update_inside_room_image" value="<?php echo $EVENTIMAGE->event_image_name; ?>">
                                                        <input type="hidden" id="room_main_id" value="<?php echo $EVENTIMAGE->id; ?>">
                                                        <input type="hidden" name="image_id"  value="<?php echo $row['room_image_id']; ?>">;   
                                                        <input type="file" name="update_inside_image" id="input-file-now-custom-2" class="dropify" data-height="500" data-default-file="<?php echo '../upload/event/image/' .$EVENTIMAGE->event_image_name; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="row">
