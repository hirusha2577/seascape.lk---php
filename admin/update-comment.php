                                            ...
                                            <form method="post" id="update_comment_form">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <input type="text" id="author_name" name="author_name" value="<?php echo $COMMENT->author_name; ?>">
                                                        <label for="fn">Author Name :</label>
                                                    </div>
                                                </div>
<!--                                                <div class="row section">
                                                    <div class="col s12 m12 l12">
                                                        <input type="file" id="author_image" name="author_image" class="dropify" data-default-file="<?php echo "../upload/comment/". $COMMENT->author_image_name; ?>">
                                                    </div>
                                                </div>-->
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <input type="text" id="email" name="email" value="<?php echo $COMMENT->email; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <div class="row">
                                                            <div class="input-field col s12">
                                                                <textarea id="comment" name="comment" class="materialize-textarea"><?php echo $COMMENT->comment; ?></textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col s12">
                                                        ...
                                                        ?>
                                                        <label>
                                                            <input type="checkbox" id="active_comment" name="active_comment" value="1" checked="checked">
                                                            <span>Active</span>
                                                        </label>
                                                        <?php
                                                            }else{
                                                        ?>
                                                        <label>
                                                            <input type="checkbox" id="active_comment" name="active_comment" value="1">
                                                            <span>Active</span>
                                                        </label>
                                                        <?php
                                                            }
                                                ...
                                                <div class="row">
                                                    <div class="row">
                                                        <div class="input-field col s12 mt-3">
                                                            ...
                                                            <button class="btn z-depth-4 border-round mr-1 waves-light gradient-45deg-cyan-light-green mb-2 waves-effect waves-light left mr-5" type="submit" name="action">Save
                                                                <i class="material-icons right">send</i>
                                                            </button>
<!--                                                            <button id="btn_delete" class=" waves-effect waves-light btn gradient-45deg-deep-orange-orange z-depth-4 border-round mr-1 mb-2" value="3">Delete</button>-->
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
