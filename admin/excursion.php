                                ...
                                <div class="col s12 m12 l12">
                                    <div id="basic-form" class="card card card-default scrollspy">
                                        <div class="card-content">
                                            <h3 class="card-title cyan-text">Create Excursion</h3>
                                            <form id="excursion_create_form" method="post">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <input type="text" id="length_and_time" name="length_and_time">
                                                        <label for="length_and_time">Length - Time :</label>
                                                    </div>
                                                </div>
                                                <div class="row section">
                                                    <div class="col s12 m12 l12">
                                                        <input type="file" id="excursion_main_image" name="excursion_main_image" class="dropify"  />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <input type="hidden" name="excursion_create">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l12">
                                <div class="row">
                                    ...
                                    foreach ($EXCURSION->all() as $key => $excursion) {
                                        ?>
                                        <div class="col s12 m3 l3">
                                            <div class="card card-border z-depth-2">
                                                <div class="card-image">
                                                    <img src="../upload/excursion/<?php echo $excursion['excursion_main_image']; ?>" alt="">
                                                </div>
                                                <div class="card-content">

                                                    <div class="row">
                                                        <div class="col s4 m4 l4 center" style="border-right: 2px solid #f1f1f1;">
                                                            <a href="update-excursion.php?id=<?php echo $excursion['excursion_id']; ?>" class=" btn-floating  waves-effect waves-light gradient-45deg-light-blue-cyan">
...
<!--                                                        <div class="col s4 m4 l4 center" style="border-right: 2px solid #f1f1f1;">
                                                        ...
                                                        <div class="col s4 m4 l4 center">
                                                            <button class=" btn-floating  waves-effect waves-light gradient-45deg-purple-deep-orange excursion_image_delete" value="<?php echo $excursion['excursion_id']; ?>">
       ...
       <!--  <script src="js/search.min.js"></script> -->
        ...
        <script src="get-post/js/excursion.js" type="text/javascript"></script>
